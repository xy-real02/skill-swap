...
export type UserExchange = Database['public']['Tables']['exchanges']['Row'] & {
  ...
  provider: Pick<Database['public']['Tables']['profiles']['Row'], 'id' | 'full_name' | 'avatar_url' | 'community_zone' | 'reputation_score'> | null
  requester: Pick<Database['public']['Tables']['profiles']['Row'], 'id' | 'full_name' | 'avatar_url' | 'community_zone' | 'reputation_score'> | null
}
